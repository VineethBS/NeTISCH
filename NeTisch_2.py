...
class MasterFrame(wx.Frame):
    def __init__(self,*args,**kwargs):
        ...
        combo1 = wx.ComboBox(self.properties_panel,-1,"Select: ",pos=(7,0),size=(150,30),
                             choices=drop1,style=wx.CB_DROPDOWN)
        ...
        combo2 = wx.ComboBox(self.properties_panel,-1,"Select: ",pos=(11,0),size=(150,30),
                             choices=drop2,style=wx.CB_DROPDOWN)
        ...
        combo4 = wx.ComboBox(self.properties_panel,-1,"Select: ",pos=(15,0),size=(150,30),
                             choices=drop3,style=wx.CB_DROPDOWN)
    ...
    def OnListBox(self, event):
        self.SetStatusText("Current Status : " + event.GetEventObject().GetStringSelection())
...
if __name__ == "__main__":
    app = wx.App()
    frame = MasterFrame(None,title = "Netisch - GUI - SampleCode2")
    frame.Show()
    app.MainLoop()
