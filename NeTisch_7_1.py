    ...
    def OnClickBrowse(self, event):
        ...
        for key1,val1 in node_data.items():
            for key2,val2 in val1.items():
                if (key2 == "length"):
                    rect_len = node_data[key1]["length"]
                    rect_bread = node_data[key1]["breadth"]
                    xpos = node_data[key1]["topright_pos_x"]
                    ypos = node_data[key1]["topright_pos_y"]
                if (key2 == "Nodes"):
