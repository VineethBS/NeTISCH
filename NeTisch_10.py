...
### ============================================================================================================
        ...
        self.nav_canvas = NavCanvas.NavCanvas(self.splitter_window, size=(600, 900), BackgroundColor="White")
        ...
        with open(os.path.join(self.dirname, self.filename), "r") as file1:
            ...
            for room,dim in T.items():
                if room == "Blank_Area":
                    ...
                    blankarea = FloatCanvas.Polygon(points,LineWidth = 4,LineColor = 'black')
